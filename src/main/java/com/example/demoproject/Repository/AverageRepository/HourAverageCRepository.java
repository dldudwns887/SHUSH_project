...
import com.example.demoproject.Entity.AverageEntity.HourAverageCEntity;
...
public interface HourAverageCRepository extends JpaRepository<HourAverageCEntity, HourAverageId> {
    ...
    List<HourAverageCEntity> findById_YearBetweenAndId_MonthBetweenAndId_DayBetween(int year, int year1, int month, int month1, int dayOfMonth, int day);
}
